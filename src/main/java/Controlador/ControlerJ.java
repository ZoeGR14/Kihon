...
public class ControlerJ extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (tipo.equals("superUsuario")) {
            ...
            request.getRequestDispatcher("Soporte/reportessG.jsp").forward(request, response);
        } else if (tipo.equals("superUsuarioM")) {
            List<Mantenimiento> listarr2 = mDao.listarM2();
            request.setAttribute("listaM", listarr2);
            request.getRequestDispatcher("Soporte/verRepManG.jsp").forward(request, response);
        } else if (tipo.equals("normal")) {
            List<Soporte> lista = dao.listar(trabajadorS);
            request.setAttribute("lista", lista);
            request.getRequestDispatcher("Soporte/reportess.jsp").forward(request, response);
        } else if (tipo.equals("normalM")) {
            List<Mantenimiento> listaM = mDao.listarM(trabajadorM);
            request.setAttribute("listaM", listaM);
            request.getRequestDispatcher("Soporte/verRepMan.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (accion) {
            ...
            case "verReporte":
                ...
                request.getRequestDispatcher("Soporte/visualizarReporte.jsp").forward(request, response);
                break;
            case "verReporte2":
                ...
                request.getRequestDispatcher("Soporte/visualizarReporteG.jsp").forward(request, response);
                break;
            case "resolver":
                ...
                dao.resolver(s);
                response.sendRedirect("ControlerJ?tipo=normal");
                break;
            case "resolver2":
                ...
                dao.resolver(s);
                response.sendRedirect("ControlerJ?tipo=superUsuario");
                break;
            ...
            case "verReporteM":
                ...
                request.getRequestDispatcher("Soporte/reportesMan.jsp").forward(request, response);
                break;
            case "verReporteM2":
                ...
                request.getRequestDispatcher("Soporte/reportesManG.jsp").forward(request, response);
                break;
            case "resolverM":
                ...
                mDao.resolverM(m);
                response.sendRedirect("ControlerJ?tipo=normalM");
                break;
            case "resolverM2":
                ...
                mDao.resolverM(m);
                response.sendRedirect("ControlerJ?tipo=superUsuarioM");
                break;
            case "cerrarReporte":
