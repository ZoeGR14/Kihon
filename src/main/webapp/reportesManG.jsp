        ...
        <a href="cierreSesion.jsp" class="logoin">
            ...
            <ul class="nav">
                ...
                <form method="post" action="ControlerJ">
                    ...
                    <form method="post" action="ControlerZ?accion=resolverM">
                        <center>

                            <textarea class="contenidoDes" name="solucionM"></textarea>
                        </center>
                        <center>
                            <button placeholder="Empieza a escribir aquí..." class="botoncito" name="id_reporteM" value="${datitoM.getId_reporte()}">Enviar solución</button>
                        </center>
