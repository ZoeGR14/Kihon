...
<html>
    ...
    <body>
        ...
        <link rel="stylesheet" href="Soporte/styleAsistente.css">
            ...
            <div class="ini_acci" id="ini_acci">
                ...
                <div class="margensito" style="margin-top: 70px; align-content: center; justify-content: center;">
                    ...
                    <center>
                        ...
                        <dialog id="modal">
                            <form action="Soporte/verificarUsuarioG.jsp" method="post" name="buscarUsu">
                    ...
                    <br>
                    <center><a href="Soporte/estatusReportes.jsp" class="bot-mag">
                            <span class="botmag_text">
                                Estatus de Reportes
                            </span>
                        </a></center>
