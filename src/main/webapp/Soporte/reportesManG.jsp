...
<html>
    <head>
        ...
        <link href="Soporte/ingreportes.css" rel="stylesheet">
        ...
        <c:choose>
            <c:when test="${not empty sessionScope.gerenteS}">
                ...
                <form method="post" action="ControlerJ">
                    ...
                    <form method="post" action="ControlerJ?accion=resolverM2">
                        <center>
                            <!--<div contenteditable placeholder="Empieza a escribir aquí..." name="solucionM" class="contenidoDes"></div>-->

                            <textarea  placeholder="Empieza a escribir aquí..."  id="miTextArea" class="contenidoDes" name="solucionM"></textarea>
                        </center>
                        <center>
