...
<html>
    <head>
        ...
        <link href="Soporte/ingtablas.css" rel="stylesheet">
    </head>
    <body>
        <c:choose>
            <c:when test="${not empty sessionScope.gerenteS}">
                ...
                <header class="headersito" id="header">
                    ...
                    <ul class="nav">
                        ...
                        <a href="Soporte/cierreSesion.jsp" class="">Cerrar Sesión</a>
                    </ul>
                </header><br><br><br>
...
<!--                    <br><form action="ControlerJ" method="post">
                        <button  class="visualizar" name="accion" value="verTabla2">Visualizar la tabla de contenido</button>    
                    </form>
                    <br>-->
                    <center>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${empty lista.getSolucion()}">
                                                <form action="ControlerJ?accion=verReporte2" method="post"><button class="botoncito" name="reporte" value="${lista.getId_reporte()}">Solucionar</button></form>
                                            </c:when>
                                            <c:otherwise>
                                                <form action="ControlerJ?accion=cerrarReporte2" method="post"><button class="botoncito" name="reporte" value="${lista.getId_reporte()}">Cerrar</button></form>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                </tr>    
