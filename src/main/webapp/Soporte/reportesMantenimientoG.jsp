...
<html>
    <head>
        ...
        <link href="Soporte/gerentes.css" rel="stylesheet">
    </head>
    <body>
        <c:choose>
            <c:when test="${not empty sessionScope.gerenteS}">
                ...
                <div id="contenedorReporte">
                    <form action="ControlerZzZ" method="post">
                                    ...
                                    <td>
                                        <c:choose>
                                            ...
                                            <c:when test="${dato.getEstatus() eq 'Programacion Finalizada'}">
                                                <form action="ControlerZzZ?accion=Gerente" method="post">
                ...
                <c:forEach var="datito" items="${lista2}">
                    <dialog class="modal">
                        ...
                        <div class='contenedorModal'>
                            ...
                            <center>
                                <form class='formGerente' name="formGerente" method="post" action='ControlerZzZ?accion=Aceptar'>
