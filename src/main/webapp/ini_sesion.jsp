                ...
                if (!res.next()) {
                    ...
                    if (res.getString("pass_tra").equals(contra)) {
                        ...
                        if (tipotra.equals("1")) {
                            ...
                            out.println("<script>function saludos(){location.href ='reportesMantenimiento.jsp';}</script>");
                            out.println("<script>setTimeout(saludos, 1500);</script>");
                            ...
                            out.println("<script>function saludos(){location.href ='reportess.jsp';}</script>");
                            out.println("<script>setTimeout(saludos, 1500);</script>");
                            ...
                            out.println("<script>function saludos(){location.href ='verRepMan.jsp';}</script>");
                            out.println("<script>setTimeout(saludos, 1500);</script>");
