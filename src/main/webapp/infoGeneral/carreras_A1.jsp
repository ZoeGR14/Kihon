...
<html>
    <head>
        ...
        <title>Carreras profesionales- ÁREA 1</title>
    ...
    <body>
        <header>
            ...
            <div class="header-content container">
                <div class="content">
                    ...
                    <br>
                    <h1>ÁREA 1. Ingeniería y Ciencias Físico Matemáticas</h1>
                    <p>
                        A continuación se enlistan las carreras universitarias que imparte el Instituto Politéncio Nacional (IPN) correspondientes al área 1.
                    </p 
        ...
        <%
            ...
            try {
                ...
                cnx = DriverManager.getConnection("jdbc:mysql://localhost:3306/KihonBase?autoReconnect=true&useSSL=false", "root", "n0m3l0");
