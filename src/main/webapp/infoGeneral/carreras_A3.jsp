...
<html>
    <head>
        ...
        <title>Carreras profesionales- ÁREA 3</title>
        ...
        <header>
            ...
            <div class="header-content container">
                <div class="content">
                    ...
                    <br>
                    <h1>ÁREA 3. Ciencias Sociales y Administrativas</h1>
                    <p>
                        A continuación se enlistan las carreras universitarias que imparte el Instituto Politéncio Nacional (IPN) correspondientes al área 3.
                    </p 
