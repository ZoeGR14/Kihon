...
<html>
    <head>
        ...
        <title>Carreras profesionales- ÁREA 2</title>
        ...
        <header>
            ...
            <div class="header-content container">
                <div class="content">
                    ...
                    <br>
                    <h1>ÁREA 2. Ciencias Médico Biológicas</h1>
                    <p>
                        A continuación se enlistan las carreras universitarias que imparte el Instituto Politéncio Nacional (IPN) correspondientes al área 2.
                    </p 
