        ...
        <div class="container">
            <form>
                ...
                <div class="section p1">
                    <h3>1. ¿Eres capaz de concentrarte durante largos períodos de tiempo?</h3>
                    <label>
                ...
                <div class="section p2">
                    <h3>2. ¿Te gusta aprender y aplicar nuevos conceptos teóricos en la práctica?</h3>
                    <label>
                ...
                <div class="section p3">
                    <h3>3. ¿Te atrae la idea de trabajar en el sector de negocios y finanzas?</h3>
                    <label>
                ...
                <div class="section p4">
                    <h3>4. ¿Te interesa la política y los sistemas gubernamentales?</h3>
                    <label>
                ...
                <div class="section p5">
                    <h3>5. ¿Te sientes cómodo con el contacto con pacientes y manejo de situaciones difíciles?</h3>
                    <label>
                ...
                <div class="section p6">
                    <h3>6. ¿Eres capaz de entender y analizar los fenómenos culturales y artísticos desde diferentes perspectivas?</h3>
                    <label>
