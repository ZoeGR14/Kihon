        ...
        <div class="container">
            <form id="testVocacional" method="post" action="/Kihon/Test_Vocacional">
                ...
                <div class="section p1">
                    <h3>19. ¿Eres capaz de trabajar en equipo para resolver problemas complejos?</h3>
                    <label>
                ...
                <div class="section p3">
                    <h3>21. ¿Te atrae la idea de investigar y descubrir nuevas formas de tratamiento para enfermedades?</h3>
                    <label>
                ...
                <div class="section p4">
                    <h3>22. ¿Eres capaz de mantener la concentración durante períodos prolongados de tiempo?</h3>
                    <label>
                ...
                <div class="section p5">
                    <h3>23. ¿Te atrae la idea de trabajar en áreas relacionadas con la historia, la arqueología y la antropología?</h3>
                    <label>
                ...
                <div class="section p6">
                    <h3>24. ¿Eres capaz de apreciar diferentes formas de arte y cultura?</h3>
                    <label>
