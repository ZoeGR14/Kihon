        ...
        <div class="container">
            <form>
                ...
                <div class="section p1">
                    <h3>1. ¿Te atrae la idea de trabajar en la industria o en el sector tecnológico?</h3>
                    <label>
                ...
                <div class="section p2">
                    <h3>2. ¿Te gusta estudiar y analizar la economía y los mercados financieros?</h3>
                    <label>
                ...
                <div class="section p3">
                    <h3>3. ¿Eres capaz de tomar decisiones críticas y rápidas en situaciones de emergencia?</h3>
                    <label>
                ...
                <div class="section p4">
                    <h3>4. ¿Te gusta estudiar los sistemas de salud y la administración de los mismos?</h3>
                    <label>
                ...
                <div class="section p5">
                    <h3>5. ¿Te interesa el cine y las diferentes formas de expresión audiovisual?</h3>
                    <label>
                ...
                <div class="section p6">
                    <h3>6. ¿Eres capaz de trabajar en equipo y colaborar en proyectos?</h3>
                    <label>
