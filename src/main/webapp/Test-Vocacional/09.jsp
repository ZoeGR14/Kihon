        ...
        <div class="container">
            <form id="testVocacional" method="post" action="/Kihon/Test_Vocacional">
                ...
                <div class="section p1">
                    <h3>49. ¿Eres capaz de adaptarte rápidamente a los cambios y desafíos?</h3>
                    <label>
                ...
                <div class="section p2">
                    <h3>50. ¿Te gusta diseñar y construir objetos o sistemas complejos?</h3>
                    <label>
                ...
                <div class="section p4">
                    <h3>52. ¿Te interesa la historia y cómo ha evolucionado la sociedad a lo largo del tiempo?</h3>
                    <label>
                ...
                <div class="section p5">
                    <h3>53. ¿Eres capaz de comunicarte efectivamente con pacientes y colegas?</h3>
                    <label>
                ...
                <div class="section p6">
                    <h3>54. ¿Te gusta la idea de trabajar en el sector de la comunicación y el periodismo?</h3>
                    <label>
