        ...
        <div class="container">
            <form>
                ...
                <div class="section p1">
                    <h3>1. ¿Te gusta analizar y procesar datos?</h3>
                    <label>
                ...
                <div class="section p2">
                    <h3>2. ¿Te gusta trabajar en equipo y colaborar en proyectos?</h3>
                    <label>
                ...
                <div class="section p3">
                    <h3>3. ¿Te gusta la biología y la química?</h3>
                    <label>
                ...
                <div class="section p4">
                    <h3>4. ¿Eres bueno en matemáticas y en aplicar la estadística?</h3>
                    <label>
                ...
                <div class="section p5">
                    <h3>5. ¿Eres creativo y tienes habilidades para la escritura, pintura, música, actuación u otras formas de expresión artística?</h3>
                    <label>
                ...
                <div class="section p6">
                    <h3>6. ¿Te gusta el estudio de las lenguas y su evolución histórica?</h3>
                    <label>
