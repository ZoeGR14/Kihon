        ...
        <c:choose>
            <c:when test="${not empty sessionScope.gerenteS}">
                ...
                <form method="post" action="ControlerJ">
                    ...
                    <form method="post" action="ControlerJ?accion=resolver2">
                        <center>
                            <textarea placeholder="Empieza a escribir aquí..." 
                                      id="miTextArea" class="contenidoDes" 
                                      name="solucion">${datito.getSolucion()}
                            </textarea>

                        </center>
                        <center>
                            <button class="botoncito" name="id_reporte" 
                                    value="${datito.getId_reporte()}">
                                Enviar solución</button>
                        </center>
